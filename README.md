...
Ваша сделать приложение, которое разместит по центку экрана одну их картинок мышей, что вы можите найти тут: https://github.com/Anaga/TARvg17/tree/master/Graphiks/Mouse/Hand-drawn-mice-collection

А также два слайдера, один из которых отвечает за вращения мыши вокруг своего "цента тяжести" - середину картинки, а втрой слайдер отвечает за "скос" картинки (shear)
...
Тема урока - Qt GraphicsScene animation

Цель - сделать приложение, которое анимирует эллипс и перемещает его по экрану, раз в секунду получая сигнал от таймера.

так же сделали отскок от границ области экрана (800*600)
...
Тема урока - Networking
Цель - сделать приложение, которое отправит GET запрос погоды на сервер
https://api.openweathermap.org/data/2.5/weather и разберет ответ
*main new topics*
- [ ] Network
- [ ] Request
